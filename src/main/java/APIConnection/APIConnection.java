...
public class APIConnection {
    ...
    //Authorization:
    private static final String basicAuth = "Basic bWlldGtpdHdhcmR5QGdtYWlsLmNvbTo4WFRlcFZGN1JXUnQ4Y2xnbVdWQzI4RkY=";
    ...
    //URLs:
    private static final String jiraURLMainProjectRepo = "https://privatematkoko.atlassian.net/";
    private static final String jiraURLNewIssue = jiraURLMainProjectRepo + "rest/api/3/issue";
    private static final String jiraURLEditSummary = jiraURLMainProjectRepo + "rest/api/3/issue/PIMK-XXXX/";
    private static final String jiraURLEditDescription = jiraURLMainProjectRepo + "rest/internal/3/issue/PIMK-XXXX/description";
    private static final String jiraURLEditPriority = jiraURLMainProjectRepo + "rest/api/2/issue/PIMK-XXXX";
    private static final String jiraURLDeleteIssue = jiraURLMainProjectRepo + "rest/api/3/issue/PIMK-XXXX";
    private static final String jiraURLSearchIssue = jiraURLMainProjectRepo + "rest/api/latest/search";

    private static final String jiraURLCreateProject = jiraURLMainProjectRepo + "rest/simplified/latest/project";
    private static final String jiraURLEditProject = jiraURLMainProjectRepo + "secure/project/EditProject.jspa";
    private static final String jiraURLGetInfoProject = jiraURLMainProjectRepo + "rest/api/latest/project/XXXX";
    private static final String jiraURLDeleteProject = jiraURLMainProjectRepo + "rest/api/2/project/XXXX";

    public static Response sendPostRequestForIssueCreation() {
        log.info("Preparing API request.");
        String payload = getPayload(locationOfPayload);
...
//                .param("applyDefaultValues", false)
    ...
    public static Response sendPutRequestForSummaryEdit(String issueId) {
        log.info("Preparing API request.");
        String payload = getPayload(locationOfPayload);
    ...
    public static Response sendPutRequestForDescriptionEdit(String issueId) {
        log.info("Preparing API request.");
        String payload = getPayload(locationOfPayload);
    ...
    public static Response sendPutRequestForPriorityEdit(String issueId) {
        log.info("Preparing API request.");
        String payload = getPayload(locationOfPayload);
    ...
    public static Response sendDeleteRequestToDeleteIssue(String issueId) {
        log.info("Preparing API request.");
...
//                .formParam("atl_token", atlToken)
    ...
    public static Response sendPostRequestForProjectCreation() {
        log.info("Preparing API request.");
        String payload = getPayload(locationOfPayload);
...
//                .header("cookie", "atlassian.xsrf.token=" + atlToken)
    ...
    private static String getPayload(String pathToPayload) {
        try {
            return JsonParserInternal.getJsonAsString(pathToPayload);
